...
import labs
from .variables import Expr, BVariable, CacheOutput, Decl

class BRVariable(BVariable):
  """
...
class BuiltinBRVariable(BRVariable):
  ...
  Builtin BRVariable
  """
  def __init__(self, doc:str, rule:BRule, name, expr:Expr):
    super().__init__(doc, rule, name, expr)


brvariable = BRVariable.decl

class BuiltinBRVariableDescriptor(object):
  """
  A descriptor to handle builtinBRVariables
  """
...
class BRule(LabsObject, UseInternal):
  ...
  class _Internal(object):
    ...
    def add_variable(self, var:BRVariable):
      self.variables[var.name] = var

  def __init__(self, build:labs.LabsBuild, name:str):
    super().__init__(build, name)
    object.__setattr__(self, 'in_', self._internal.variables)
  ...
  def __contains__(self, key):
    return key in self._internal.variables
